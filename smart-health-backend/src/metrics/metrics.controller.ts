...
export class MetricsController {
    private flaskUrls: Record<string, string> = {
        diabetes: 'http://<ec2-ip>:5000/predict-diabetes', // http://localhost:5000/predict-diabetes
        heart: 'http://<ec2-ip>:5000/predict-heart', // http://localhost:5000/predict-heart
        stroke: 'http://<ec2-ip>:5000/predict-stroke', // http://localhost:5000/predict-stroke
    };
